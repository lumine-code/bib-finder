...
module.exports = {
  ...
  activate(state) {
    ...
    this.disposables = new CompositeDisposable(
      ...
      lumine.config.observe("bib-finder.bibPaths.path.no1", (value) => {
        this.bibPath1 = value;
        this.items = null;
      }),
      lumine.config.observe("bib-finder.bibPaths.path.no2", (value) => {
        this.bibPath2 = value;
        this.items = null;
      }),
      lumine.config.observe("bib-finder.bibPaths.path.no3", (value) => {
        this.bibPath3 = value;
        this.items = null;
      }),
      lumine.config.observe("bib-finder.bibPaths.path.no4", (value) => {
        this.bibPath4 = value;
        this.items = null;
      }),
      lumine.config.observe("bib-finder.bibPaths.path.no5", (value) => {
        this.bibPath5 = value;
        this.items = null;
      }),
  ...
  async refresh(sourceId) {
    this.items = null;
    this.nextId = sourceId;
    return this.selectList.isVisible() ? this.selectList.reload() : this.update(sourceId);
  },
  ...
  openBibFile(id) {
    let filePath = lumine.config.get(`bib-finder.bibPaths.path.no${id}`);
    if (filePath) {
